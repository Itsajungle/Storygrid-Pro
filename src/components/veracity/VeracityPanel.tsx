...
import { AlertCircle, ExternalLink, Check, X, RefreshCw } from 'lucide-react';
...
const VeracityPanel: React.FC<VeracityPanelProps> = ({ 
  results, 
  onStatusChange,
  isLoading,
        ...
        <Card key={result.id} className="p-4 bg-white border border-gray-300 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-700 mb-3 bg-gray-50 p-2 rounded border">"{result.flaggedText}"</p>
              ...
              {result.suggestion && (
                <div className="mb-3">
                  ...
                  <div className="bg-gray-50 p-3 rounded border border-gray-200">
                    <Textarea 
                      className="text-sm text-gray-900 bg-white border-gray-300 resize-none min-h-[60px]" 
              ...
              <div className="flex items-center gap-2 mt-2">
                <Button 
                  ...
                  onClick={() => onStatusChange(result.id, 'accepted')}
                  className={result.status === 'accepted' ? 'bg-green-600 hover:bg-green-700 text-white' : 'text-gray-800 border-gray-300'}
                >
                ...
                <Button 
                  ...
                  onClick={() => onStatusChange(result.id, 'dismissed')}
                  className={result.status === 'dismissed' ? 'bg-gray-600 hover:bg-gray-700 text-white' : 'text-gray-800 border-gray-300'}
                >
                ...
                <Button 
                  ...
                  onClick={() => onStatusChange(result.id, 'needs-rewrite')}
                  className={result.status === 'needs-rewrite' ? 'bg-amber-600 hover:bg-amber-700 text-white' : 'text-gray-800 border-gray-300'}
                >
